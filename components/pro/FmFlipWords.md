---
url: /components/pro/FmFlipWords.md
---
# FmFlipWords 翻转文字
...
```vue
<template>
  <FmFlipWords :words="['React', 'Vue', 'Svelte']" :duration="2000" />
</template>
```
...
<template>
  <div class="text-center py-8">
    ...
    <FmFlipWords :words="features" :duration="2500" />
  </div>
</template>
```
