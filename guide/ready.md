...
专业版用户会被邀请加入到 [Fantastic-mobile](https://github.com/fantastic-mobile) Github 官方组织，加入组织后在专业版仓库 [Releases](https://github.com/fantastic-mobile/pro/releases) 页面下载最新版本的压缩包。
