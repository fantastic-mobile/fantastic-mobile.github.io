import{_ as s,c as i,o as a,a5 as n,a7 as l}from"./chunks/framework.DJ1OgcvL.js";const y=JSON.parse('{"title":"配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/configure.md","filePath":"guide/configure.md"}'),p={name:"guide/configure.md"},t=n(`<h1 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h1><h2 id="环境配置" tabindex="-1">环境配置 <a class="header-anchor" href="#环境配置" aria-label="Permalink to &quot;环境配置&quot;">​</a></h2><p>默认提供三套环境配置，分别为：</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-mMqez" id="tab-87CV_n7" checked><label for="tab-87CV_n7">.env.development 开发环境</label><input type="radio" name="group-mMqez" id="tab-E0-hTUG"><label for="tab-E0-hTUG">.env.test 测试环境</label><input type="radio" name="group-mMqez" id="tab-AdspB2U"><label for="tab-AdspB2U">.env.production 生产环境</label></div><div class="blocks"><div class="language-yaml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 应用配置面板</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    website: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;https://fantastic-mobile.github.io&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  },</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><div class="warning custom-block"><p class="custom-block-title">注意</p><p>文档中提供的配置介绍，如果在本地的开发环境使用中报错或者无法生效，说明你使用的版本不支持或者配置参数有变动，你可以打开 <code>/src/settings.default.ts</code> 查看当前版本的完整配置作为参考。</p><p>并且如果你使用的是 Visual Studio Code ，鼠标悬浮到属性上时，会有属性的介绍：</p><p><img src="`+l+'" alt="" data-zoomable=""></p></div>',12),e=[t];function h(k,E,d,r,c,g){return a(),i("div",null,e)}const F=s(p,[["render",h]]);export{y as __pageData,F as default};
